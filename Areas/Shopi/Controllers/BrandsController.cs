...
namespace YeniShoppingProject.Areas.Shopi.Controllers
{
    public class BrandsController : Controller
    {
        ...
        // GET: Shopi/Brands/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Shopi/Brands/Create
