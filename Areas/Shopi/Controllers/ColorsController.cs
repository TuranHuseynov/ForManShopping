...
namespace YeniShoppingProject.Areas.Shopi.Controllers
{
    public class ColorsController : Controller
    {
        ...
        // GET: Shopi/Colors/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Shopi/Colors/Create
